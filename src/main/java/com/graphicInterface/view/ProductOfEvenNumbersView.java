...
import com.javaProject.controlers.ProductOfEvenNumbers;

/**
 *
 * @author juann
 */
public class ProductOfEvenNumbersView extends javax.swing.JPanel {

    /**
     * Creates new form LeapYearView
     */
    public ProductOfEvenNumbersView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Este programa multiplica todos los números pares de la lista");
    ...
    private void consultMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_consultMouseClicked
        ...
        try{
            ...
            ProductOfEvenNumbers productOfEvenNumbers = new ProductOfEvenNumbers(listNumbers);
            String valuReturn = productOfEvenNumbers.runProgram();
